                ...
                while (escena) {
                    ...
                    while (combate) {
                        ...
                        switch (accion) {
                            case 1:
                                int ataqueAleatorio = random.nextInt(4);
                                int ataqueAleatorio2 = random.nextInt(4);
                                String attack = arrayataque[ataqueAleatorio];
                                String attack2 = arrayataque[ataqueAleatorio2];
                                ...
                                break;
                            case 2:
                                int ataqueAleatorio3 = random.nextInt(4);
                                String attack3 = arrayataque[ataqueAleatorio3];
